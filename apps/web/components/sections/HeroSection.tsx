...
import { LegacyArticle as Article } from '@repo/db';
              ...
              <div className="relative overflow-hidden rounded-xl shadow-lg group h-[500px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-gray-200 text-sm">{headlineArticle.timestamp || headlineArticle.publishedAt ? new Date(headlineArticle.timestamp || headlineArticle.publishedAt || headlineArticle.createdAt || '').toLocaleDateString() : new Date().toLocaleDateString()}</span>
                  </div>
                  ...
                  <p className="text-gray-200 line-clamp-2 mb-4">
                    {headlineArticle.excerpt || (headlineArticle.content?.substring(0, 150) + '...') || 'Baca selengkapnya...'}
                  </p>
